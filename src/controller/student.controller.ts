...
export const getStudent = async function(req:Request, res:Response, next:NextFunction) {
   try{
...
export const studentLogin = async function(req:Request,res:Response){
   try{
...
export const exportStudentData = async(req:Request,res:Response,next:NextFunction) => {
  try{
