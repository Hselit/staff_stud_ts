...
router.post(
  "/studentlogin",
  studentValidator_1.validateStudentLogin,
  student_controller_1.studentLogin
);
//get student method
...
router.get(
  ...
  student_controller_1.exportStudentData
);
...
router.get(
  ...
  auth_1.verifyToken,
  auth_1.roleMiddleware,
  studentValidator_1.validateStudentId,
  student_controller_1.getStudentById
);
//student post method
router.post(
  "/",
  auth_1.verifyToken,
  auth_1.roleMiddleware,
  imageUpload_1.default.single("profile"),
  studentValidator_1.validateStudentCreate,
...
router.put(
  ...
  auth_1.roleMiddleware,
  imageUpload_1.default.single("profile"),
  studentValidator_1.validateStudentUpdate,
...
router.delete(
  ...
  auth_1.roleMiddleware,
  studentValidator_1.validateStudentId,
  student_controller_1.deleteStudent
);
...
router.get(
  ...
  auth_1.roleMiddleware,
  studentValidator_1.validateStudentId,
  student_controller_1.getStaffs
);
