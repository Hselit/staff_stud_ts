...
const validateStaffCreate = [
    ...
    (0, express_validator_1.body)("experience")
        ...
        .isInt({ min: 0, max: 50 })
        .withMessage("experience must be in range of 0-50"),
    (0, express_validator_1.body)("email").trim().notEmpty().isEmail().withMessage("Invalid Email"),
    handleValidationError,
];
...
const validateStaffCSV = [
    (0, express_validator_1.body)("data").isArray({ min: 1 }).withMessage("Data Must not be empty"),
