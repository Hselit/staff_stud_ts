...
exports.resetpage = exports.forgotpassword = exports.exportStaffData = exports.bulkInsertFromcsv = exports.getcsv = exports.getStudents = exports.deleteStaff = exports.updateStaff = exports.createStaff = exports.getStaffById = exports.getStaff = exports.staffLogin = void 0;
...
const createStaff = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield Staff.create({ staffName, role, experience, password, email });
...
const bulkInsertFromcsv = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const staffData = req.body.data;
        // const InsertData = staffData.map(row =>)
        yield Staff.bulkCreate(staffData);
...
const exportStaffData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const resetpage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log("in password verify route");
    res
        .status(200)
        .send(`<h3 style="text-align:center;">Password Reset Success</h3><br><h2 style="text-align:center;">Thank You.....</h2>`);
});
